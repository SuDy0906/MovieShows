...
const BookingForm = (props) => {
    ...
    return (
        <>
            {
                !showForm ?
                    <Button onClick={handleBookNow} variant="dark" type="submit">
                        Book Now
                    </Button>
                    :
                    <Form onSubmit={handleFormSubmit} style = {{ borderRadius:"40px"}}>
                        ...
                        <Form.Group className="mb-3 text-light" controlId="formBasicUserName">
